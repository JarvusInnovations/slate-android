...
private BroadcastReceiver rec;
	...
	private static final String ANDROID_SERIAL= android.os.Build.SERIAL;
...
//	public void postBootData() throws ClientProtocolException, IOException, JSONException{
//	//	boolean isDone = false;
//		
//		SharedPreferences deviceINFO = this.getSharedPreferences("SlateDeviceInfo", MODE_PRIVATE);
//		String macAddress = deviceINFO.getString("MacAddress", "");
//		String deviceID = deviceINFO.getString("DeviceID", "");
//		String dat = deviceINFO.getString("Date", "");
//		String UPtime = Long.toString(UPTIME);
//		
...
//		nameValuePairs.add(new BasicNameValuePair("LastBootTime", dat));
//		nameValuePairs.add(new BasicNameValuePair("Uptime", UPtime));
//		httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
//        HttpResponse response = httpclient.execute(httppost);
//        Log.i("SLATEd", "Boot Data Sent");
//        ByteArrayOutputStream os = new ByteArrayOutputStream(); 
//		response.getEntity().writeTo(os); 
//		String responseString = os.toString();
//		Log.i("SLATEd", responseString);
//		JSONObject rspObj = new JSONObject(responseString);
//		boolean isDataSent = rspObj.getBoolean("status");
//			if(isDataSent){
//				Log.i("SLATEd", "Log Sent Successfuly");
//			}else if(!isDataSent){
//				Log.i("SLATEd", "BooT Log Not Sent SErver ProbLEm");
//			}
//	}
