...
public class WilcoReceiver extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
		Log.i("SLATEd", "Service Called: onStartCommand");
	    	if(intent.getAction().equalsIgnoreCase(Intent.ACTION_SCREEN_OFF)){
	    		...
	    		Intent i = new Intent(context, WilcoService.class);
	    		...
	    		Log.i("SLATEd", "User Present Hello");
			...
			//context.startService(new Intent(context, WilcoService.class));			
	}
